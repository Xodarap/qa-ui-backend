...
var Question = React.createClass({
  rawMarkup: function() {
    var rawMarkup = JSON.stringify(this.props);//marked(this.props.children.toString(), {sanitize: true});
...
var CommentList = React.createClass({
  render: function() {
    var commentNodes = this.props.data.map(function(comment) {
      return (
        <Question question={comment.question} key={comment.id} answer={comment.answer}>       
